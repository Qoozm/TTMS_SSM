...
<head>
	...
	<%--<script type="text/javascript" src="../../../static/js/datepicker/WdatePicker.js"/>--%>
	...
	<script language="JavaScript">
        ...
        function searchTicketScheduleByPlayName() {

            var playName = document.getElementById("playName").value;
            window.location.href = "/searchTicketScheduleByPlayName?playName=" + playName + "";
        }
//        var reqStudio;
//        var reqPlay;
//        var studioId;
		...
		<div class="ctab-Mian-cont">
			<div class="Mian-cont-btn clearfix">
				<div class="operateBtn">
					...
					<%--<a href="javascript:;" class="greenbtn add sp-add">添加计划</a>--%>
				...
				<div class="searchBar">
					...
					<input type="button" height="20" class="srhBtn" value="" onclick="searchTicketScheduleByPlayName()">
				</div>
			</div>
					...
					<tr id="<%=schedule.getSched_id()%>">
						...
						<td class="t_9">
							<div class="btn"><%--<a class="Top">置顶</a>--%>
								...
								<a href="/doSale?scheduleId=<%=schedule.getSched_id()%>&studioId=<%=schedule.getStudio_id()%>" target="Mainindex" class="delete">选座</a>
							</div>
						</td>
					</tr>
					<%
